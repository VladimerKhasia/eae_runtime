...
class BlockDecomposer:
    ...
    def decompose(model) -> List[nn.Module]:
        """Best-effort dispatcher: nn.Sequential -> children, list-like -> list,
        single nn.Module -> a one-block model."""
        ...
        raise TypeError(
            ...
            "Pass an nn.Sequential, a list of nn.Module, or a single nn.Module."
        )
